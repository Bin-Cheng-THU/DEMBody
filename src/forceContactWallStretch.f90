    ...
    !     ***********
    !
    !     Force for stretch contactable wall.
    !     --------------------------
    !      
    ...
    !
    !********************************************************************
    subroutine forceContactWallStretch()
    ...
    OMP_contactWallTag = contactWallStretchTag
    do K = 1,3
        OMP_contactWallPoint(K) = contactWallStretchPoint(K)
        OMP_contactWallVector(K) = contactWallStretchVector(K)
    end do
    ...
    !$OMP& slipping,rolling,twisting,touching,Vx,Vy) SCHEDULE(GUIDED)
    do I = 1,N
        do K = 1,3
