    ...
    !     ***********
    !
    !     Force for mirrored bidisperse particles.
    !     --------------------------
    !      
    ...
    do I = 1,biDisperseNum
        ...
        !################         Wall X1          ################### 
        if (BiTag1(I).EQ.1) then
            Tail => HeadBiDisperse(I)
            do J = 1,biDisperseNum
                if (BiTag2(J).EQ.1) then
        ...
        !################         Wall X2          ################### 
        if (BiTag2(I).EQ.1) then
            Tail => HeadBiDisperse(I)
            do J = 1,biDisperseNum
                if (BiTag1(J).EQ.1) then   !  .OR. I.EQ.N
        ...
        !################         Wall Y1          ################### 
        if (BiTag3(I).EQ.1) then
            Tail => HeadBiDisperse(I)
            do J = 1,biDisperseNum
                if (BiTag4(J).EQ.1) then   !  .OR. I.EQ.N
                    !  Initialize state params
                    do K = 1,3
                        Dist(K) = biDisperseX(K,J) -  biDisperseX(K,I)
                        H(K) = 0.0D0
                    ...
                    Dist(1) = shearPBC - biDisperseX(1,I)
                    !**************************
                    touching = .false.
                    slipping = .false.
                    rolling = .false.
        ...
        !################         Wall Y2          ################### 
        if (BiTag4(I).EQ.1) then
            Tail => HeadBiDisperse(I)
            do J = 1,biDisperseNum
                if (BiTag3(J).EQ.1) then   !  .OR. I.EQ.N
                    !  Initialize state params
                    do K = 1,3
                        Dist(K) = biDisperseX(K,J) -  biDisperseX(K,I)
                        H(K) = 0.0D0
