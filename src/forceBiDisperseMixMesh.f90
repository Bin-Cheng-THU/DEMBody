    ...
    !     ***********
    !
    !     Force for biParticles using mix Parallel Lattice.
    !     -------------------------------
    !
    ...
    !
    !********************************************************************
    subroutine forceBiDisperseMixMesh()
    ...
    type(MixLattice),pointer :: IDLattice       !  List of mixLattices
    type(biDisperseLattice),pointer :: IDParticle !  List of particles
